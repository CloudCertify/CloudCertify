...
/// attempt type: in a Drill it is committed at Check and is immutable (a Check is final);
...
public class RecordedAnswer
{
    ...
    /// a Drill, which collects no Confidence (ADR 0006).
    /// </summary>
    public Confidence? Confidence { get; set; }

    /// <summary>
    /// Whether the selection was correct, judged when the answer was committed — at Check in a
    /// Drill, at answer-commit in a full Quiz, re-stamped on revision until Submit — and never
